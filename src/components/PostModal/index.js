...
export default function PostModal({ title }) {
  ...
  function CreatePostDialogue() {
    ...
    return (<>
      ...
      <div className={clsx(`h-full w-ful items-start flex flex-col gap-20  justify-center`, { 'hidden': MediaChange === true, 'block': MediaChange === false })}>
        <textarea className="w-full h-50 resize-none focus:outline-none focus:shadow-none ring-transparent focus:ring-transparent border-transparent focus:border-transparent"
          placeholder="What's on your mind, kapil?"
          // value={PostTitle}
          onClick={(e) => { setPostTitle(e.target.value) }}
        />
      ...
      <div className={clsx({ 'block': MediaChange === true, 'hidden': MediaChange === false })}>
        <div className="overflow-y-scroll h-60">
          ...
          <div className={clsx(`border-2 rounded-md flex flex-col justify-between p-2 relative`, { 'hidden': MediaChange === false })}>
            <div className="absolute top-4 right-4 kapil p-1 cursor-pointer" onClick={onClick}  >
      ...
      <div className="flex items-center justify-between border-2 py-3 px-3 mt-3 rounded-md">
        ...
        <div className="down-icons flex gap-5 items-center">
          <IconsRender title="photo/video" img="img/first.png" onClick={onClick} active={clsx({ 'bg-gray-200': Active })} />
          <IconsRender title="Tag people" img="img/second.png" onClick={() => { setNextDialogue(2) }} />
          <IconsRender title="felling/activity" img="img/third.png" onClick={() => { setNextDialogue(3) }} />
          <IconsRender title="check in" img="img/fourth.png" onClick={() => { setNextDialogue(4) }} />
      ...
      <button className="bg-blue-600 w-full rounded-md text-white p-2 mt-4 mb-4">Post</button>
    </>
    )
  }
    ...
    return (
      ...
      <div>
        ...
        <div
          ...
          <div>
          <div className="text-gray-600 text-xs p-1"><p>SEARCH</p></div>
  ...
  function FeelingsDialogue() {
    ...
    return (
      <>
        <h1 className={clsx('absolute left-0 transition duration-500 ease-in-out', { "block": NextDialogue === 2 })}>Feelings</h1>
  ...
  function IconsRender({ title, img, onClick, active }) {
    return (
      <Tooltip title={title}>
        <div className={clsx("hover:bg-gray-200 p-1 rounded-full cursor-pointer", active)} onClick={onClick}>
          <img src={img} />
        </div>
      </Tooltip>
    )
